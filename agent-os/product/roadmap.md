...
> Version: 1.2.0
> Status: v1 shipped — latest public release v1.0.88 (2026-07-06). The built-in triage engine (5 milestones, 2026-07-13) is complete on `main` and awaiting its release cut.
...
**Post-v1.0.88 (unreleased on `main`):**
